void buttonSet(){
  ...
  //リザルト画面
  button[7] = new Button(width/2, height/2, 300, 80, color(190, 100, 70), "もう一度遊ぶ");
  button[8] = new Button(width/2, height/2 + 100, 300, 80, color(190, 100, 70), "タイトルへ");
  
  
  button[9] = new Button(width/2, height/2, 300, 80, color(190, 100, 70), "Game Start");
